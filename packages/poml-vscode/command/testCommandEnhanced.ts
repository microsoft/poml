...
export class TestCommandEnhanced implements Command {
  public id = 'poml.test';
...
export class TestNonChatCommandEnhanced extends TestCommandEnhanced {
...
export class TestRerunCommandEnhanced implements Command {
...
export class TestAbortCommandEnhanced implements Command {
