...
describe('jump to source', () => {
  test('double click posts didClick message', () => {
    ...
    const ir = '<env presentation="markup" markup-lang="markdown" original-start-index="0" original-end-index="71"><p original-start-index="0" original-end-index="71"><p speaker="ai" original-start-index="3" original-end-index="34">hello</p><p speaker="human" original-start-index="35" original-end-index="67">world</p></p></env>';
    const content = [
  ...
  test('double click plain text span posts didClick', () => {
    ...
    const ir = '<env presentation="markup" markup-lang="markdown" original-start-index="0" original-end-index="29"><p original-start-index="0" original-end-index="29">hello <b original-start-index="6" original-end-index="17">world</b></p></env>';
    const state = {
      source: 'file.poml',
      line: 0,
      lineCount: raw.split(/\r?\n/).length,
